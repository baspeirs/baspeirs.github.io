...
export const projectList = [
    ...
    },
    {
        ...
        poweredBy: "JavaScript, React, Redux, Google Cloud Platform, Google Sheets API, HTML5, and CSS3. Page hosted with Heroku and repository stored on GitHub.",
        page: "https://redshift-7118cedb54a9.herokuapp.com/",
        github: "https://github.com/baspeirs/RedShiftGuild",
        theme: {
            background: '#8A1103',
            text: 'white'
        }
